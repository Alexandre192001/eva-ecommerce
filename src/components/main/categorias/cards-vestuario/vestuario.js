...
export default function CardVestuario(){
   // Carrossel
  ...
  return(
    <Fragment>
      <section className="sessao-vestuario-wrapper">
        <h1 className="titulo-sessao">Destaques em Vestuário</h1>
        <div className="carrossel-vestuario-wrapper" ref={carrossel}>
        ...
        <div className="container-setas-vestuario">
        <div onClick={handleLeftClick} className="seta-carrossel-left-vestuario">
          <div className="setacima"></div>
          <div className="setabaixo"></div>
        </div>

        <div onClick={handleRightClick} className="seta-carrossel-right-vestuario">
          <div className="setacima"></div>
          <div className="setabaixo"></div>
        </div>
        </div>
